...
var $rtfeldman$elm_css$Svg$Styled$Attributes$dx = $rtfeldman$elm_css$VirtualDom$Styled$attribute('dx');
...
var $author$project$Main$feDropShadow = $rtfeldman$elm_css$Svg$Styled$node('feDropShadow');
...
var $rtfeldman$elm_css$Svg$Styled$Attributes$stdDeviation = $rtfeldman$elm_css$VirtualDom$Styled$attribute('stdDeviation');
		...
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Svg$Styled$Attributes$width('120'),
							$rtfeldman$elm_css$Svg$Styled$Attributes$height('120'),
							$rtfeldman$elm_css$Svg$Styled$Attributes$viewBox('0 0 120 120'),
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											A2($rtfeldman$elm_css$Css$property, 'filter', 'url(#shadow)')
										]))
								]))
						]),
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Svg$Styled$Attributes$id('shadow')
								]),
							_List_fromArray(
								[
									A2(
									$author$project$Main$feDropShadow,
									_List_fromArray(
										[
											$rtfeldman$elm_css$Svg$Styled$Attributes$stdDeviation('3'),
											$rtfeldman$elm_css$Svg$Styled$Attributes$dx('0.2'),
											$rtfeldman$elm_css$Svg$Styled$Attributes$dy('0.4')
										]),
									_List_Nil)
								])),
							A2(
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Svg$Styled$Attributes$x('10'),
									$rtfeldman$elm_css$Svg$Styled$Attributes$y('10'),
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											A2($rtfeldman$elm_css$Css$property, 'filter', 'drop-shadow(3px 5px 2px rgb(0 0 0 / 0.4))')
										]))
								]))
						]),
					_List_fromArray(
